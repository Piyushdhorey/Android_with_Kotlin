...
class AddHappyPlacesActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding?.etdate?.setOnClickListener(this@AddHappyPlacesActivity)
                ...
                if (data != null) {
                    ...
                    try {
                       ...
                       val saveImageToInternalStorage =
                        ...
                        e.printStackTrace()
                        Toast.makeText(this@AddHappyPlacesActivity, "Failed!", Toast.LENGTH_SHORT)
                            .show()
                    }
                }
            } else if (requestCode == CAMERA) {

                val thumbnail: Bitmap = data!!.extras!!.getString("data") as Bitmap // Bitmap from camera
